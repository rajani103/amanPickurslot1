...
function UpdateSlot()
{
    ...
    const response = await fetch(`http://52.15.66.36:8080/interviewerservice/api/v1/${emailId}`);
    ...
    function Addslot(props)
    {
            ...
            const addSlottoserver = () =>{
                ...
                axios.post('http://52.15.66.36:8080/interviewerservice/api/v1/newSlot', newSlot)
...
{
    console.log(props);
    axios.delete(`http://52.15.66.36:8080/interviewerservice/api/v1/${props}`).then((res)=> {
            console.log(res);
    })
